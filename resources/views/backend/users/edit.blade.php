    ...
    <div class="container-fluid">
        ...
        <div class="container-fluid shadow-lg">
            <div class="row clearfix">
                ...
                <div class="col-sm-8 mx-auto" style="margin-top: 10px; margin-bottom: 50px; margin-top: 50px; margin-bottom: 130px;">
                    <form action="{{route('users.update',$user->id)}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-12 col-sm-12">
                                <div class="form-group {{ $errors->has('username') ? 'has-error' : '' }}">
                                    ...
                                    <input class="form-control" type="text" name="username" required value="{{$user->name}}">
                        ...
                        <input type="submit" class="btn btn-theme" style="color: white;" name="btnEditUser" value="Update">
