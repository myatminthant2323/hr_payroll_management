                    ...
                    <form action="{{route('employees.update',$employee->id)}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-sm-12 my-4">
                                <h3 class="d-inline">Edit Employee</h3>
                            ...
                            <div class="col-sm-12 mb-2">
                                ...
                                <input type="file" class="dropify" data-allowed-file-extensions="jpg jpeg png" name="photo" id="edit_emp_photo" data-default-file="{{asset($employee->photo)}}">
                            </div>

                            <div class="col-sm-6">
                                <div class="form-group {{ $errors->has('first_name') ? 'has-error' : '' }}">
                                    <label class="col-form-label">First Name <span class="text-danger">*</span></label>
                                    <input class="form-control" type="text" name="first_name" value="{{$employee->fname}}">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group {{ $errors->has('last_name') ? 'has-error' : '' }}">
                                    ...
                                    <input class="form-control" type="text" name="last_name" value="{{$employee->lname}}">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="password" class="form-control @error('password') is-invalid @enderror" name="password" autocomplete="new-password" id="password">
                                    @error('password')
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input data-provide="datepicker" data-date-autoclose="true" class="form-control" placeholder="Birthdate" data-date-format="yyyy-mm-dd" name="dob" value="{{$employee->date_of_birth}}">
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6">  
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input data-provide="datepicker" data-date-autoclose="true" class="form-control" placeholder="Joining Date" data-date-format="yyyy-mm-dd" name="join_date" value="{{$employee->join_date}}">
                                    </div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group {{ $errors->has('phone_one') ? 'has-error' : '' }}">
                                    ...
                                    <input class="form-control" type="text" name="phone_one" value="{{$employee->phno1}}">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="phone_two" value="{{$employee->phno2}}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="select form-control" name="designation_id">
                                            ...
                                            <option value="{{$designation->id}}" @if($employee->designation_id == $designation->id)
                                                {{'selected'}} 
                                                @endif>{{$designation->designation_name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-3">
                                                        <label class="form-check-label">
                                                            <input type="radio" class="form-check-input" name="gender" checked="checked" value="male" 
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-check">
                                                <div class="row">
                                                    <div class="col-sm-3">
                                                        <label class="form-check-label">
                                                            <input type="radio" class="form-check-input" name="martialradio" checked="checked" value="single"
                                                    ...
                                                    <div class="col-sm-3">
                                                        <label class="form-check-label">
                                                            <input type="radio" class="form-check-input" name="martialradio" value="married"
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group {{ $errors->has('role') ? 'has-error' : '' }}">
                                            ...
                                            <select class="form-control" name="role">
                                                ...
                                                <option value="{{$role->name}}" @if($role->name == $user_role)
                                                {{'selected'}} 
                                    ...
                                    <div class="col-12">
                                        <div class="form-group {{ $errors->has('address') ? 'has-error' : '' }}">
                                            ...
                                            <textarea class="form-control" id="exampleFormControlTextarea1" rows="7" name="address">{{$employee->address}}</textarea>
                                            <span class="text-danger">{{ $errors->first('address') }}</span>
                                        </div>
                                    </div>
                                </div>
                                <button type="submit" class="btn btn-theme" style="color: white;">Update</button>
                            </form>
                        </div>
                    </div>
                </div>
