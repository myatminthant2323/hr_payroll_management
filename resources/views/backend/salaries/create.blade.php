                    ...
                    <form action="{{route('salaries.store')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            <div class="col-sm-12 my-4">
                                <h3 class="d-inline">Add Salary <span class="text-danger"> (Monthly)</span></h3>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group {{ $errors->has('basic_salary') ? 'has-error' : '' }}">
                                    ...
                                    <input class="form-control" type="number" name="basic_salary" min="0">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group {{ $errors->has('basic_working_time') ? 'has-error' : '' }}">
                                    ...
                                    <input class="form-control" type="number" name="basic_working_time" min="0">
                            ...
                            <!-- <div class="col-sm-6">
                                <div class="form-group {{ $errors->has('overtime_rate') ? 'has-error' : '' }}">
                                    ...
                                    <input class="form-control" type="number" name="overtime_rate">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group {{ $errors->has('basic_salary') ? 'has-error' : '' }}">
                                    ...
                                    <input class="form-control" type="number" name="leave_allowance" min="0">
                                    <span class="text-danger">{{ $errors->first('basic_salary') }}</span>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-12">
                                <div class="form-row my-3">
                                    <div class="col mr-2">
                                        ...
                                        <input class="form-control" type="number" name="medical_allowance" min="0">
                                    </div>
                                    <div class="col ml-2">
                                        <label class="col-form-label">EPF <span class="text-danger">(%)</span></label>
                                        <input class="form-control" type="number" name="epf" min="0"  step=".01">
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="form-row my-3">
                                    <div class="col mr-2">
                                        ...
                                        <input class="form-control" type="number" name="transport_allowance" min="0">
                                    </div>
                                    <div class="col ml-2">
                                        <label class="col-form-label">ESI <span class="text-danger">(%)</span></label>
                                        <input class="form-control" type="number" name="esi" min="0"  step=".01">
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="form-row my-3">
                                    <div class="col mr-2">
                                        ...
                                        <input class="form-control" type="number" name="accomodation_allowance" min="0">
                                    </div>
                                    <div class="col ml-2">
                                        <label class="col-form-label">Other Insurance</label>
                                        <input class="form-control" type="number" name="other_insurance" min="0">
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="form-row my-3">
                                    <div class="col mr-2">
                                        ...
                                        <input class="form-control" type="number" name="other_allowance" min="0">
                                    </div>
                                    <div class="col ml-2">
