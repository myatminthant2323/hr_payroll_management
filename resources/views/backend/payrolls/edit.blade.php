                    ...
                    <form action="{{route('payrolls.update',$payroll->id)}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            <div class="col-sm-12 my-4">
                                <h3 class="d-inline">Edit Payment <span class="text-danger"> (Monthly)</span></h3>
                            ...
                            <div class="col-sm-6">
                                    <div class="form-group {{ $errors->has('payment_month') ? 'has-error' : '' }}">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input data-provide="datepicker" data-date-autoclose="true" class="form-control payment_month" name="payment_month" id="datepicker" value="{{$payroll->payment_month}}">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group {{ $errors->has('payment_date') ? 'has-error' : '' }}">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input data-provide="datepicker" data-date-autoclose="true" class="form-control payment_date" data-date-format="yyyy-mm-dd" name="payment_date" value="{{$payroll->payment_date}}">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <select class="select form-control emp_name" name="staff" readonly="readonly">
                                        
                                        <!-- <option selected="selected">Select Staff...</option> -->
                                        
                                        <option value="{{$employee->id}}" selected="selected">{{$employee->username}}</option>
                            ...
                            <div class="col-sm-12">
                                <div class="form-row my-3">
                                    <div class="col mr-2">
                                        <label class="col-form-label">Attendance Bonus</label>
                                        <input class="form-control" type="number" name="attendance_bonus"  min="0" value="{{$payroll->attendance_bonus}}">
                                    </div>
                                    <div class="col ml-2">
                                        <label class="col-form-label">Attendance Deduction</label>
                                        <input class="form-control" type="number" name="attendance_deduction"  min="0" value="{{$payroll->attendance_deduction}}">
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="form-row my-3">
                                    <div class="col mr-2">
                                       <label class="col-form-label">Other Bonus</label>
                                       <input class="form-control" type="number" name="other_bonus" min="0" value="{{$payroll->other_bonus}}">
                                   </div>
                                   <div class="col ml-2">
                                    <label class="col-form-label">Other Deduction</label>
                                    <input class="form-control" type="number" name="other_deduction"  min="0" value="{{$payroll->other_deduction}}">
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6">
                        ...
                        <div class="col-sm-6">
                            <div class="form-row my-3">
                                <div class="col-sm-12 mr-2">
                                    ...
                                    <input class="form-control leave_deduction" type="number" name="leave_deduction" id="leave_deduction" readonly="readonly">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea rows="6" class="form-control no-resize" name="comment" id="leave_note">{{$payroll->comment}}</textarea>
                            </div>
                        </div>


                    </div>
                    <input type="submit" class="btn btn-theme" name="btnEditPayment" value="Update">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        var selectedEmployeeEditID = $("select.emp_name option:selected").val();
        var selectedEditDate = $(".payment_month").val();
        getSalaryReady(selectedEmployeeEditID, selectedEditDate);
        getOvertimeReady(selectedEmployeeEditID , selectedEditDate);
        getLeaveReady(selectedEmployeeEditID , selectedEditDate);
        ...
        $(".payment_month").on('change',function(){
            ...
            getSalary(selectedEmployeeEditID, selectedDate);
            console.log("overtime before ajax ",selectedEmployeeEditID)
            getOvertime(selectedEmployeeEditID , selectedDate);
            getLeave(selectedEmployeeEditID , selectedDate);
        ...
        if(id !== "" && date !== ""){
            ...
            success:function(response) {
                ...
                if(total_leave_in_current_month !== 0){
                    ...
                    $('#leave_note').html(old_note+" &#13;&#10; Total Leave in Current Month - "+total_leave_in_current_month+" days");
                }else{
                    var old_note = $('#leave_note').text();
                    $('#leave_note').html(old_note+" &#13;&#10; *You have no leave in current Month*");
                }
            }
        }
    });
    ...
    function getLeaveReady(id , date) {
        console.log("leave ",id)
        if(id !== "" && date !== ""){
            $.ajax({
               type:'POST',
    ...
    function getSalaryReady(id , date) {
        var selectedSalary;
    ...
    function getOvertimeReady(id , date) {
